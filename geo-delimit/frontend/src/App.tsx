...
// Sugestões de siglas (texto livre — o usuário pode digitar qualquer outra)
const FACCAO_SUGESTOES = ['CV', 'PCC', 'ADA', 'TCP', 'PCV'];

// Cor sugerida automaticamente por sigla conhecida (o usuário pode sobrescrever manualmente)
        ...
        <div style={{ padding: '72px 16px 16px', overflowY: 'auto', flex: 1, minWidth: 340, display: 'flex', flexDirection: 'column' }}>
          ...
          {activeTab === 'data' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              {/* Campo Sigla/Facção territorial */}
              <div>
