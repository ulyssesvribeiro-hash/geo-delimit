...
export default function App() {
  ...
  // ─── Desenha o polígono principal (cidade ou bairro selecionado) ─────────
  ...
  useEffect(() => {
    if (currentGeometry) drawMainPolygon(currentGeometry, style);
  }, [style, currentGeometry, drawMainPolygon]);

  // ─── Animação de pulsação (apenas no polígono principal) ──────────────────
  useEffect(() => {
