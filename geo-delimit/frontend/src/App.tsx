...
// Definição dos tiles para cada tema do mapa (CartoDB, gratuito, sem token)
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Insere o tile sempre como camada de fundo (abaixo do layerGroup de polígonos)
      ...
      <div style={{ position: 'absolute', top: 0, left: 0, right: 0, zIndex: 1000, padding: '12px 16px', display: 'flex', alignItems: 'center', gap: 12, background: mapTheme === 'dark' ? 'linear-gradient(to bottom, rgba(0,0,0,0.9), transparent)' : 'linear-gradient(to bottom, rgba(255,255,255,0.9), transparent)' }}>
        ...
        <button onClick={() => setMapTheme(t => (t === 'dark' ? 'light' : 'dark'))}
          ...
          style={{
            ...
            borderRadius: 8,
            color: mapTheme === 'dark' ? '#FFD700' : '#444',
        ...
        <button onClick={() => setSidebarOpen(v => !v)}
          style={{
            ...
            borderRadius: 8,
            color: mapTheme === 'dark' ? '#00FFFF' : '#0088aa',
            cursor: 'pointer', fontSize: 16, flexShrink: 0,
          }}>
          {sidebarOpen ? '◀' : '▶'}
        </button>
        ...
        <div style={{ padding: '72px 16px 16px', overflowY: 'auto', flex: 1, minWidth: 340, display: 'flex', flexDirection: 'column' }}>
          ...
          {activeTab === 'list' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, flex: 1, minHeight: 0 }}>
              ...
              <button onClick={fetchSavedAreas} style={{
                  ...
                  >
                    <div onClick={() => handleLoadSavedArea(area)}
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ color: mapTheme === 'dark' ? '#e0e0e0' : '#222', fontSize: 13, fontWeight: 600, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
